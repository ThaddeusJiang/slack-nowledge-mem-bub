...
async def test_send_captures_assistant_in_same_slack_thread(monkeypatch) -> None:
    captures: list[dict[str, Any]] = []

    async def _capture(**kwargs: Any) -> None:
        captures.append(kwargs)

    monkeypatch.setattr("bub_slack.channel.capture_slack_message", _capture)
    ch, _ = _channel_with_web()
